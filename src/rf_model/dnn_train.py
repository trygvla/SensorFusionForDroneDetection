...
def build_model(input_dim):
    """
    Build a feed-forward DNN for binary classification with BatchNormalization.
    """
    model = Sequential([
...
def main():
    ...
    # Ensure model is saved in native Keras format
